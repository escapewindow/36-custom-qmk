...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),    QK_LLCK,                                        TOGGLE_LAYER_COLOR,RGB_TOG,        RGB_MODE_FORWARD,RGB_SLD,        KC_RIGHT_SHIFT, KC_TRANSPARENT, 
