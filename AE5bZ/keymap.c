...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, MT(MOD_LALT, KC_BSLS),MT(MOD_LGUI, KC_MINUS),MT(MOD_LCTL, KC_LBRC),MT(MOD_LSFT, KC_RBRC),QK_REP,                                          KC_LEFT,        MT(MOD_RSFT, KC_DOWN),MT(MOD_RCTL, KC_UP),MT(MOD_RGUI, KC_RIGHT),MT(MOD_RALT, KC_QUOTE),KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_LEFT_SHIFT,  CW_TOGG,        TD(DANCE_0),    TD(DANCE_1),    QK_LLCK,                                        KC_NO,          KC_GRAVE,       KC_EQUAL,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
