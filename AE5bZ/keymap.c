...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, MT(MOD_LALT, KC_BSLS),MT(MOD_LGUI, KC_MINUS),MT(MOD_LCTL, KC_LBRC),MT(MOD_LSFT, KC_RBRC),KC_NO,                                          KC_LEFT,        MT(MOD_RSFT, KC_DOWN),MT(MOD_RCTL, KC_UP),MT(MOD_RGUI, KC_RIGHT),MT(MOD_RALT, KC_QUOTE),KC_TRANSPARENT, 
