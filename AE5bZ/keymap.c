...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_LEFT_SHIFT,  KC_NO,          TD(DANCE_0),    TD(DANCE_1),    QK_LLCK,                                        KC_NO,          KC_GRAVE,       KC_EQUAL,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
